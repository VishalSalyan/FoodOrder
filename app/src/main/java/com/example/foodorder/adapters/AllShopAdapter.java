...
public class AllShopAdapter extends RecyclerView.Adapter<AllShopAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final FoodData foodData = SessionData.getInstance().totalFoodList.get(position);
    ...
    public int getItemCount() {
        if (SessionData.getInstance().totalFoodList == null) {
            return 0;
        }
        return SessionData.getInstance().totalFoodList.size();
    }
