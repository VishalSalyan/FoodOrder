...
public class BestDealAdapter extends RecyclerView.Adapter<BestDealAdapter.ViewHolder> {
    ...
    public BestDealAdapter(Context context, ArrayList<FoodData> foodList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_best_deal, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            container = itemView.findViewById(R.id.cv_best_deal);
